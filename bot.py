...
async def ai(interaction: discord.Interaction, prompt: str):
    ...
    model = user_models.get(user_id, "Meta-Llama-3.3-70B-Instruct")
    ...
    system_prompt = {
        ...
        "content": (
            ...
            f"Personality: {user_personas.get(user_id, 'helpful, friendly, concise')}.\n"
            f"You are inside Discord."
        )
    }
    ...
    if len(user_memory[user_id]) > 20:
        user_memory[user_id] = [user_memory[user_id][0]] + user_memory[user_id][-19:]
